...
/**
 * client for the ementas api (parsing, http connection)
 */
        ...
        try {
            ...
            for (int dailyEntry = 0; dailyEntry < menuOptionsArray.length(); dailyEntry++) {
                ...
                if (dailyOption.isAvailable()) {
                    ...
                    dailyOption.addMealCourse(new MealCourse(UAMenus.COURSE_ORDER_MEAT_NORMAL, parseForObjectOrString(jsonArray2, UAMenus.COURSE_ORDER_MEAT_NORMAL) ));
                    dailyOption.addMealCourse(new MealCourse(UAMenus.COURSE_ORDER_FISH_NORMAL, parseForObjectOrString(jsonArray2, UAMenus.COURSE_ORDER_FISH_NORMAL) ));
