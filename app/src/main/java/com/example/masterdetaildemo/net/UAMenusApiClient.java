...
public class UAMenusApiClient {
    ...
    public String getMenusForCanteen2() {
    ...
    public String getCantines(String forecastJsonStr, final String selectedSite){
        UAMenus menus = UaMenusParserUtility.parseJson(forecastJsonStr);
